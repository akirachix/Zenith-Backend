...
class DrainageSystemModelTest(TestCase):
    ...
    def test_drainage_system_creation(self):
        drainage_system = DrainageSystem.objects.get(Drainage_ID=self.drainage_system.Drainage_ID)
    ...
    def test_drainage_system_string_representation(self):
        self.assertEqual(str(self.drainage_system), f'Drainagesystem {self.drainage_system.Drainage_ID}')
